...
namespace TeamSuneat.Setting
{
    public class GamePlay
    {
        ...
        public bool HideUserInterface
        {
            ...
            set
            {
                if (_isHideUserInterface != value)
                {
                    ...
                    GamePrefs.SetBool(GamePrefTypes.OPTION_IS_HIDE_USERINTERFACE, value);
                }
            }
        }
        ...
        public void Load()
        {
            ...
            if (GamePrefs.HasKey(GamePrefTypes.OPTION_IS_HIDE_USERINTERFACE))
            {
                _isHideUserInterface = GamePrefs.GetBool(GamePrefTypes.OPTION_IS_HIDE_USERINTERFACE);
            }
            else
            {
